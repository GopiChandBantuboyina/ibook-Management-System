...
<body class="bg-light">
	...
	<div class="container">
		<h3 class="text-center pt-2 pb-1 text-info">Recent Books</h3>
		<div class="row">

			<%
			bookDAOimpl dao = new bookDAOimpl(DBconnect.getcon());
			List<bookdtls> book = dao.getAllRecentBooks();
			for (bookdtls b : book) {
			%>
			<div class="col-md-3">
				<div class="card crd-ho mt-2">
					<div class="card-body text-center">
						...
						{%>
							...
							<%}else{ %> 
								<a href="cart?uid=<%=us.getId()%>&&bid=<%=b.getBookid()%>&&page=<%="allRecentBooks"%>" class="btn btn-danger btn-sm"><i class="fa-solid fa-cart-shopping"></i> Add Cart</a>
							<%} %>
							<a
